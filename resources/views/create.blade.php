...
<body>
    <div class="container py-4">
        ...
        <form method="POST" action="{{ route('larabergcms.store') }}">
            @csrf
            ...
            <div class="row g-3">
                ...
                <div class="col-12">
                    ...
                    <input type="text" id="slug" name="slug"
                           ...
                           value="{{ old('slug') }}" placeholder="optional">
                ...
                <div class="col-md-6">
                    ...
                    <input type="url" id="image" name="image"
                           ...
                           value="{{ old('image') }}" placeholder="https://... optional">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            var mainForm = document.querySelector('form[method="POST"][action="{{ route('larabergcms.store') }}"]');
            if (mainForm) {
